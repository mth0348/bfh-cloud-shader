...
\lstdefinelanguage{HLSL}{
	morekeywords=[1]{
        position,sphere,direction,stepSize,dirMultiplier,distanceScene,distanceOrigin,
	},
	morekeywords=[2]{
		distance,normalize,
		sphereHit,raymarch,sphereDistance,
	},
	morekeywords=[3]{
		STEP_SIZE,MAX_STEPS,MINIMUM_STEP_SIZE,SURFACE_DISTANCE,MAX_DISTANCE,
    },
