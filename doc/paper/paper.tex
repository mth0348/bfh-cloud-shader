...
\lstdefinelanguage{HLSL}{
	morekeywords=[1]{
        % variables
        position,sphere,direction,stepSize,dirMultiplier,dScene,dOrigin,p,dMin,dMax,result,k,
	},
	morekeywords=[2]{
        % methods and functions
		distance,normalize,min,max,dot,pow,
		sphereHit,raymarch,sphereDistance,sceneSDF,estimateNormal,hardshadow,softshadow
	},
	morekeywords=[3]{
        % CONSTANTS
