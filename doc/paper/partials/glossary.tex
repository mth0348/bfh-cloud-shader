...
\newglossaryentry{ambientocclusion}{name=Ambient occlusion, text={ambient occlusion}, description={ This method darkens points in the scene that are not or only slightly exposed to the light and its environment }}
\newglossaryentry{noise}{name=Noise, text={noise}, description={ A randomly generated pattern, referring to procedural pattern generation }}
...
\newglossaryentry{sunlightforwarding}{name=Sunlight forwarding, text={sunlight forwarding}, description={ The process of sunlight shining through and illuminating the clouds which cover or are close to the sun }} 
\newglossaryentry{sunlighttransmittance}{name=Sunlight transmittance, text={sunlight transmittance}, description={ The same as \gls{sunlightforwarding} }} 
