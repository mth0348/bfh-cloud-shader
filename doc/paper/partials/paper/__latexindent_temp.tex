...
\begin{figure}[H]
    ...
    \begin{minipage}{0.47\linewidth}
        ...
        \begin{tikzpicture}[scale=0.8, x=2cm,y=2cm]
            ...
            \node[red] at (s1) {\textbullet};
            \node[red] at (s2) {\textbullet};
            \node[red] at (s3) {\textbullet};
            \node[red] at (s4) {\textbullet};
            \node[red] at (s5) {\textbullet};
            \node[red] at (s6) {\textbullet};
            \node[red] at (s7) {\textbullet};
            \node[red] at (s8) {\textbullet};
            \node[red] at (s9) {\textbullet};
...
\noindent
As clearly visible in \autoref{img:tikz:noise:voronoi2}, hard conturs are still visible along the grid lines. This issue is fixed by including the adjacent cells when finding the closest seed for a given fragment.
