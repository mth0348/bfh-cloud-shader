...
\begin{figure}[H]
    ...
    \captionof{figure}{Prototype: Rendered image of the final prototype (day scene).}
    \label{img:captures:prototype_final:day}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{unity captures/final shot prototype 3.PNG}
    \captionof{figure}{Prototype: Rendered image of the final prototype (night scene).}
