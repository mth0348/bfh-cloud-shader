...
\begin{figure}[H]
    ...
    \captionof{figure}{Camparison: photographic reference \protect\cite{img:campare:altocumulus} versus the rendered image.}
...
\begin{figure}[H]
    ...
    \captionof{figure}{Camparison: photographic reference \protect\cite{img:campare:altocumulus:night} versus the rendered image (at night).}
...
\begin{figure}[H]
    ...
    \captionof{figure}{Camparison: photographic reference \protect\cite{img:campare:altocumulus:sunset} versus the rendered image (at sunset).}
...
\begin{figure}[H]
    ...
    \captionof{figure}{Camparison: photographic reference \protect\cite{img:campare:altocumulus:stormy} versus the rendered image (stormy).}
...
\subsubsection{Professional Meterological Assessment}
Another viable solution is to let a professional meteorologist inspect and rate the rendered images and judge the realism of the depicted scenarios, which should at least reveal if the rendered images could even exist in reality.
