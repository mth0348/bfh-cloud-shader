...
\begin{figure}[H]
    ...
    \captionof{figure}{Prototype: Rendered image of sunlight forwarding.}
...
\emptyline
The following code snippet shows the implementation of the sunlight forwarding mechanism. The \lstinline[language=HLSL]{density} variable is the one evaluated in \autoref{lst:shader:prototype:sampledensity}.

\begin{lstlisting}[language=HLSL, caption=Implementation of a sunlight forwarding mechanism., label=lst:shader:prototype:sampledensity]
...
\clearpage
\subsubsection{Suburface scattering}
