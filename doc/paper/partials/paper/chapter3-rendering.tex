...
In \gls{raymarching}, rendering cast shadows  proves to be rather easy. Naturally, the light ray comes from the sun, bounces off in the world and eventually may hit the eye of the observer.
Since only a minute fraction of those rays actually hit the observer (the camera), a huge amount of rays would be calculated for nothing.
