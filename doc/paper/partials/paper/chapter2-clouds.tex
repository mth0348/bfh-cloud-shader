...
\paragraph{Billboards}
Another rather simple way of rendering clouds is by only showing 2D images. When always facing the main camera, those are called \gls{billboard}s.
