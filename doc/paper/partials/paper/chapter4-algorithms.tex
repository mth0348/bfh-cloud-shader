...
\\
In shaders, fBms are also called \textit{fractal noise}. They are usually implemented by adding different iterations of noise, while successively incrementing the frequencies in regular steps and decreasing the amplitude of the noise.
