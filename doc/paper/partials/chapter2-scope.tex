...
\subsection{Vision}
For projects which involve researching and prototyping like this one, it is imperative to define a high-level vision of what the resulting work could be used for.
As depicted in \autoref{img:rendered1}, 
